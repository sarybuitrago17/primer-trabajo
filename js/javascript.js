...
function calcularPerimetro() {
  ...
  document.getElementById("resultadoPerimetro").innerHTML = "Perímetro: " + perimetro;
}
...
function calcular0() {
    ...
    switch(figura) {
      case "cuadrado":
        ...
        resultado1.innerHTML = "<p>Área : " + area + "</p>";
        break;
      case "rectangulo":
  ...
  function calcular2() {
    ...
    switch(figura) {
      case "cuadrado":
        ...
        resultado2.innerHTML = "<p>Perímetro: " + perimetro + "</p>";
        break;
      case "rectangulo":
